    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Staff', 'Staff'), ('Instructor', 'Instructor'), ('Student', 'Student')], default='Student', max_length=14)),
            ...
            options={
                'permissions': [('can_view_courses', 'Can view available courses'), ('can_edit_courses', 'Can edit course content'), ('can_manage_users', 'Can manage user accounts')],
            },
        ),
    ]
